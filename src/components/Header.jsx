                    ...
                    <div className="container">
                        ...
                        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul className="navbar-nav ml-auto">                                
                                ...
                                <li className="nav-item">
                                    <NavLink className="nav-link" activeClassName="text-info" to="/login">Login</NavLink>
                                </li>
                                <li className="nav-item">
                                    <NavLink className="nav-link" activeClassName="text-info" to="/signup">Sign up</NavLink>
                                </li>
                                <li className="nav-item">
